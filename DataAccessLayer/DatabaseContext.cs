...
namespace DataAccessLayer
{
...

    {
            ...
            var connectionString = "Server=DESKTOP-TUMHS1A\\NA;Database=Armut;Integrated Security=True";
            dbContextOptionsBuilder = new DbContextOptionsBuilder<DatabaseContext>();
